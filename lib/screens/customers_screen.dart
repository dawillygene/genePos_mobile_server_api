...
import 'package:gene_pos/services/customer_service.dart';
...
class _CustomersScreenState extends State<CustomersScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Customer Configuration', style: TextStyle(fontWeight: FontWeight.bold, color: kWhiteColor)),
          ...
          child: FutureBuilder<List<Customer>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return const Center(child: Text('No customers found. Add one to get started!', style: TextStyle(color: kWhiteColor, fontSize: 18)));
              }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildCustomerListItem(customer, index);
                },
              );
            },
          ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Add Customer', style: TextStyle(color: kWhiteColor)),
        tooltip: 'Add a new customer',
      ),
    );
  }

  Widget _buildCustomerListItem(Customer customer, int index) {
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          Icon(
                            customer == null ? Icons.add_box_rounded : Icons.edit_rounded,
                            size: 40,
                            color: kSecondaryColor,
                          ),
                          const SizedBox(height: 8),
                          Text(
                            customer == null ? 'Create New Customer' : 'Update Customer',
                    ...
                    _buildDialogTextField(nameController, 'Customer Name', Icons.person),
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () {
                              ...
                              if (name.isNotEmpty) {
                                if (customer == null) {
                                  _addCustomer(Customer(name: name, phone: phone, address: address));
                                } else {
                                  _updateCustomer(customer.copyWith(name: name, phone: phone, address: address));
                                }
                                Navigator.pop(context);
                              } else {
                                _showSnackBar('Customer name is required.', Colors.orange);
                              }
                            },
                            ...
                            icon: Icon(
                              customer == null ? Icons.add_circle : Icons.check_circle,
                              color: kWhiteColor,
                              size: 20,
                            ),
                            label: Text(
  ...
  void _addCustomer(Customer customer) async {
    ...
    _loadCustomers();
    _showSnackBar('Customer added successfully!', Colors.green.shade600);
  }

  void _updateCustomer(Customer customer) async {
    await _customerService.updateCustomer(customer);
    _loadCustomers();
    _showSnackBar('Customer updated successfully!', Colors.blue.shade600);
  }

  void _deleteCustomer(int id) async {
    await _customerService.deleteCustomer(id);
    _loadCustomers();
    _showSnackBar('Customer deleted successfully!', Colors.red.shade700);
  }
